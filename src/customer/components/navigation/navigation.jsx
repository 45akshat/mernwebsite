...
export default function Example() {
  ...
  return (
    <header className="bg-white header_main">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <div className="flex lg:hidden">
          ...
          >
            ...
            <Bars3Icon aria-hidden="true" className="h-6 w-6 stroke-white" />
          </button>
        </div>
                ...
                <div className="p-4">
                  {allProducts.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="block rounded-lg p-4 text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-50"
                    >
                      {item.name}
                    </a>
                  ))}
