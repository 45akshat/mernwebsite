...
export const initiatePayment = async (amount, name, email, contact, user, orderItems, shippingAddress, navigate, dispatch) => {
  ...
  const orderResponse = await axios.post("http://13.200.231.124:5454//payment/createOrder", {
  ...
  const options = {
    ...
    handler: async function (response) {
      ...
      try {
        ...
        const verifyResponse = await axios.post("http://13.200.231.124:5454//payment/verifyPayment", data);
